	...
	try {
		...
		try {
				bson = require('bson');
					...
					console.dir(err)
				console.error("Eric message js-bson: Failed to load c++ bson extension, using pure JS version");
					throw new Error("Eric s-bson: Failed to load c++ bson extension, using pure JS version");
					}
